      ...
      method(method)
{
    ...
    spinBox->setKeyboardTracking(false);
    spinBox->setRange(1, 9999);
    connect(spinBox, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged), method, &Method::setNrPlane, Qt::QueuedConnection);
    ...
    connect(checkBox, &QCheckBox::toggled, method, &Method::setUseLocalCost, Qt::QueuedConnection);
