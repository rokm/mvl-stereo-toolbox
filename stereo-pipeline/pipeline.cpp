...
void Pipeline::writeMatrixToBinaryFile (const cv::Mat &matrix, const QString &fileName, bool compress)
{
    QFile file(fileName);
...
// *********************************************************************
void Pipeline::createColorCodedDisparityCpu (const cv::Mat &disparity, cv::Mat &image, int numLevels)
{
...
void Pipeline::createAnaglyph (const cv::Mat &left, const cv::Mat &right, cv::Mat &anaglyph)
{
