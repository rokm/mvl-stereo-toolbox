...
#ifndef CALIBRATION_PATTERN_SETTINGS_DIALOG_H
#define CALIBRATION_PATTERN_SETTINGS_DIALOH_H

#include <QtGui>

class CalibrationPattern;

class CalibrationPatternSettingsDialog : public QDialog
{
public:
    CalibrationPatternSettingsDialog (QWidget * = 0);
    virtual ~CalibrationPatternSettingsDialog ();
