...
void SourceUnicapConfigWidget::updateLeftCamera ()
{
    updateCamera(configLeftDevice, frameLeftDevice, source->getLeftCamera());
}

void SourceUnicapConfigWidget::updateRightCamera ()
{
    updateCamera(configRightDevice, frameRightDevice, source->getRightCamera());
}


void SourceUnicapConfigWidget::updateCamera (QWidget *&deviceConfig, QFrame *&deviceFrame, CameraUnicap *newDevice)
{
