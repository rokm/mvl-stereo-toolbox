/*
 * Unicap Image Source: camera list
...
void CameraList::setDeviceList (const QVector<unicap_device_t> &list)
{
    // Clear old entries
    if (entries.size()) {
...
void CameraList::setActive (const unicap_device_t &dev, bool value)
{
...
const unicap_device_t &CameraList::getDeviceInfo (int c) const
{
    return entries[c];
}
