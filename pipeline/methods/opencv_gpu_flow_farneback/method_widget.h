...
#ifndef STEREO_METHOD_FLOW_FARNEBACK_GPU_CONFIG_WIDGET_H
#define STEREO_METHOD_FLOW_FARNEBACK_GPU_CONFIG_WIDGET_H
...
protected:
    ...
    QSpinBox *spinBoxNumberOfLevels;
    QDoubleSpinBox *spinBoxPyramidScale;
    QCheckBox *checkBoxFastPyramids;
    QSpinBox *spinBoxWindowSize;
    QSpinBox *spinBoxNumberOfIterations;
    QSpinBox *spinBoxPolyN;
    QDoubleSpinBox *spinBoxPolySigma;
    QCheckBox *checkBoxUseGaussianFilter;
};
