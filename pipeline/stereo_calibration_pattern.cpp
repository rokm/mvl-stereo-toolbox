...
StereoCalibrationPattern::StereoCalibrationPattern (int width, int height, float size, PatternType type, int levels, float increment)
{
...
// *                            Parameters                             *
// *********************************************************************
void StereoCalibrationPattern::setParameters (int newPatternWidth, int newPatternHeight, float newElementSize, PatternType newPatternType, int newMaxScaleLevel, float newScaleIncrement)
{
...
const cv::Size StereoCalibrationPattern::getPatternSize () const
{
    return patternSize;
}
